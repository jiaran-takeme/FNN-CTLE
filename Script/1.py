...
r1.parameters["R"].value = "100 Ohm"
r1.update_item_annotation()

rx_diff1 = design.find_instance("Rx_Diff1")
rx_diff1.parameters['Gain'].value = "2e11"
...
# 导出测量指标CSV
meas_csv_filename = os.path.join(target_output_dir, f"{target_probe}_眼图测量指标.csv")
